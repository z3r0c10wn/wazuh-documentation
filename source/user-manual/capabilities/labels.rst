...
Addition configuration information is available in the :doc:`Analysis section <../reference/ossec-conf/analysis>` of ``ossec.conf``. This includes information on ``label_cache_maxage`` and ``show_hidden_labels`` options.
